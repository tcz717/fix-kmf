define([
    'jquery', 'https://rawgithub.com/aui/artTemplate/master/dist/template.js', 'gre/js/mod/screenword/screen_word'
], function (a, b, c) {
    var sc = a('gre/js/mod/screenword/screen_word');
    var d = a('jquery');
    sc.prototype.render = function () {
        var t = a("https://rawgithub.com/aui/artTemplate/master/dist/template.js");
        var b,
